...
const Gallery = () => {
  ...
  const projects = [
    {
      id: 1,
      title: "Modern Banyo Renovasyonu",
      category: "bathroom",
      location: "İstanbul",
      beforeImage:
    ...
    {
      id: 6,
      title: "Komple Renovasyon ve Dekorasyon",
      category: "renovation",
      location: "İstanbul",
      beforeImage:
        "https://images.unsplash.com/photo-1584622650111-993a426fbf0a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    ...
    <section id="gallery" className="section-padding bg-secondary">
      <div className="container-max">
        <div className="text-center mb-20">
          ...
          >
            İstanbul'un her ilçesinde gerçekleştirdiğimiz kaliteli işlerimizi
            keşfedin
          </p>
        </div>
